...
public class TrMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TrMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IceandollieModMenus.TR.get(), id);
