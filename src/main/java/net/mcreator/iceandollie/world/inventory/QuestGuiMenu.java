...
package net.mcreator.iceandollie.world.inventory;
...
public class QuestGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public QuestGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(IceandollieModMenus.QUEST_GUI.get(), id);
