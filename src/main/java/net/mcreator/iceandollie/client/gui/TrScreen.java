...
public class TrScreen extends AbstractContainerScreen<TrMenu> {
	...
	public TrScreen(TrMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("iceandollie:textures/screens/quest_gui.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 256, 256, 256, 256);
