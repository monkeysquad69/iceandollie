 ...
 *
 */
package net.mcreator.iceandollie;
...
@Mod("iceandollie")
public class IceandollieMod {
	public static final Logger LOGGER = LogManager.getLogger(IceandollieMod.class);
	public static final String MODID = "iceandollie";
